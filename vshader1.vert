...
out vec4 l0; //wektor do swiatla w przestrzeni oka
...
void main(void) {
    ...
    l0=normalize(V*position0-V*M*vertex); //Wektor do swiatla w przestrzeni oka
    l1=normalize(V*position1-V*M*vertex); //Wektor do swiatla w przestrzeni oka
